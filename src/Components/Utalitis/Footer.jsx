...
export const Footer = () => {
   const { isOpen: openIcons } = useSelector(
     (state) => state.iconsView
);
  return (
    <>
      <footer className={`p-4 my-6 mx-4 bg-white rounded-lg shadow ${openIcons?"sm:ml-68":"md:ml-25"} md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800`}>
